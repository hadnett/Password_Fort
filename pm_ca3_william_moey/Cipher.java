...
public class Cipher
{
    ...
    // #######################################################
    /**
     * Returns true if the passed byte array is of size 128, 192, or 256 bits --
     * the only acceptable key sizes for AES.
     *
     * @param key
     * @return
     */
    ...
    /**
     * Given a string of plaintext, and a 128, 192, or 256-bit key (encoded as
     * base-64) encrypts the string using AES256-CBC (configurable in
     * CIPHER_TYPE const).
     *
     * Note the returned string bundles the initialization vector and
     * ciphertext, separated by a | character.
     *
     * @param plaintext The plaintext string to encrypt
     * @param base64Key The key to use for encryption, 128, 192, or 256 bytes as
     * a base64-encoded string
     * @return Encrypted ciphertext as a base64-encoded string the
     * initialization vector and ciphertext are both included, separated by a |
     * character
     */
    ...
    // #######################################################
    /**
     * Given a string of ciphertext created with the encryptString method, and a
     * 128, 192, or 256-bit key (encoded as base-64), decrypts the string using
     * AES256-CBC (configurable in CIPHER_TYPE const).
     *
     * @param ciphertext The ciphertext string to decrypt, inclusive of
     * initialization vector (format: iv|ciphertext).
     * @param base64Key The key to use for encryption, 128, 192, or 256 * bytes
